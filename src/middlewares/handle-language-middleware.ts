...
//
// export function handleLanguageMiddleware(request: NextRequest, response: NextResponse) {
...
//     try {
//       const siteSettings = JSON.parse(siteSettingsCookie) as { state: SiteSettingsStoreState };
//       if (siteSettings.state?.region && acceptedRegions.includes(siteSettings.state.region)) {
